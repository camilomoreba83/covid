...
import co.edu.unab.covid_app.http.MarcadorSingleton;
    ...
    View.OnClickListener eventoMain = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            ...
            if(view.getId()==R.id.btnIniciarSesion){
                        ...
                        new Response.Listener<String>() {
                            ...
                            public void onResponse(String response) {
                                ...
                                if (pass.isEmpty() || email.isEmpty()){
                                    ...
                                    //////////probar extraer info de identify//////////////////////////
                                    /*
                                    Log.d("estatus=",Config.usuario.getStatus().toString());
                                    Log.d("datos", String.valueOf(datos));
                                    Integer id = Integer.parseInt(String.valueOf(Config.usuario.getIdentify().get("sub")));
                                    String nombre = String.valueOf(Config.usuario.getIdentify().get("name"));
                                    String e_mail = String.valueOf(Config.usuario.getIdentify().get("email"));
                                    String apellido = String.valueOf(Config.usuario.getIdentify().get("surname"));
                                    String token = String.valueOf(Config.usuario.getToken());
                ...
                MarcadorSingleton.getInstance(getApplicationContext()).addQueue(solicitud);
